...
class Permissions_SnailFishShopModel
{
...
**/
	...
	public function is_perm_plugin($pluginname = '', $iscom = false)
	{
		...
		$permset = intval(load_class('cache')->getString('permset', 'global'));
	...
	{
		$path = IA_ROOT . '/addons/lionfish_comshop/data/global';
	...
	public function log($type = '', $op = '')
	{
		...
		pdo_insert('lionfish_comshop_perm_log', $log);
	}
