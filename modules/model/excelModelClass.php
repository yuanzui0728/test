...
class Excel_SnailFishShopModel
{
	...
	public function export_delivery_goodslist( $list, $params = array() )
	{
		...
		$excel = new PHPExcel();
		$excel->getProperties()->setCreator('超级商城')->setLastModifiedBy('超级商城')->setTitle('Office 2007 XLSX Test Document')->setSubject('Office 2007 XLSX Test Document')->setDescription('Test document for Office 2007 XLSX, generated using PHP classes.')->setKeywords('office 2007 openxml php')->setCategory('report file');
	...
	**/
	public function export_delivery_list_pi( $params_list, $list = array() )
	{
		...
		require_once IA_ROOT . '/framework/library/phpexcel/PHPExcel.php';
		$excel = new PHPExcel();
		$excel->getProperties()->setCreator('超级社区团购')->setLastModifiedBy('超级社区团购')->setTitle('Office 2007 XLSX Test Document')->setSubject('Office 2007 XLSX Test Document')->setDescription('Test document for Office 2007 XLSX, generated using PHP classes.')->setKeywords('office 2007 openxml php')->setCategory('report file');
		$sheet = $excel->setActiveSheetIndex(0);
