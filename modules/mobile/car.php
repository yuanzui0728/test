...
////&soli_id=11&community_id=438&buy_type=  solitaire
	...
	**/
	...
	$need_data['score_for_money'] = sprintf('%.2f', $score_for_money);//会员能抵扣的金额 sprintf()
	...
	**/
	...
	if( !empty($weprogram_use_templatetype) &&  $weprogram_use_templatetype == 1 )
	{
		...
		{
			$weprogram_subtemplate_send_order = load_model_class('front')->get_config_by_name('weprogram_subtemplate_send_order');
