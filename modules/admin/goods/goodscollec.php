...
class Goodscollec_Snailfishshop extends AdminController
{
	public function main()
	{
		...
		switch($type)
		{
			case 'taobao':
				$typename = '淘宝';
				$fetch_url = ShopUrl('goods.goodscollec/fetch');
			break;
			case 'jingdong':
				$typename = '京东';
				$fetch_url = ShopUrl('goods.goodscollec/jingdongfetch');
			break;
			case 'ali':
				$typename = '1688';
				$fetch_url = ShopUrl('goods.goodscollec/alifetch');
				break;
			case 'pinduoduo':
				$typename = '拼多多';
				$fetch_url = ShopUrl('goods.goodscollec/pinduoduofetch');
			break;
		}
	...
	**/
	public function fetch()
	{
		...
		$ret = load_class('caiji')->get_item_taobao($itemid, $_GPC['url'], $cates);
	...
	**/
	...
	/**
		采集拼多多商品
	**/
	public function pinduoduofetch()
	{
